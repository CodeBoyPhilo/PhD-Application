...
\hw{While these methods may require less amounts of labeled training data and are often model-agnostic, finding out how to best fuse the heterogeneous information between KGs and LLMs for question-answering remains an open research challenge.}
